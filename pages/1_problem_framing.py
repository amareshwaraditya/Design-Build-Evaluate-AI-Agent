...
st.set_page_config(page_title="Phase 1 - Problem Framing")
st.title("Phase 1 — Problem Framing & Domain Understanding")
st.caption("Rubric: Problem Framing & Domain Understanding (10 pts)")
